  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <h4 style="font-weight: bold; margin-bottom: 30px; ">Data User</h4>
        <div class="row">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <form method="post" action="<?= base_url('utama/hapus_user') ?>">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <form method="post" action="<?= base_url('utama/edit_user') ?>">
                                ...
                                <div class="form-group">
                                  <label for="recipient-name" class="col-form-label">Username:</label>
                                  <input type="text" name="username" class="form-control" id="recipient-name" required="" value="<?= $data['username'] ?>">
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="password" name="pass" class="form-control" id="recipient-name" required="" value="">
                                </div>
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <input type="submit" name="edit" class="btn btn-primary" value="Edit Password">
                              </div>
                            </form>
