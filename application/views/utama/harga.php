  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <h4 style="font-weight: bold; margin-bottom: 30px; ">Data Harga</h4>
        <div class="row">

          <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#myModalAdmin">Tambah Harga</button>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="modal-footer">
                    ...
                    <input type="submit" name="kirim" class="btn btn-primary" value="Tambah Harga">
                  </div>
                </form>
              </div>
            </div>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <form method="post" action="<?= base_url('utama/hapus_harga') ?>">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <form method="post" action="<?= base_url('utama/edit_harga') ?>">
                                  <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                  <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">Harga:</label>
                                    <input type="text" name="harga" class="form-control" id="recipient-name" required="" value="<?= $data['harga'] ?>">
                                  </div>
                                ...
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                  <input type="submit" name="edit" class="btn btn-primary" value="Edit Harga">
                                </div>
                              </form>
